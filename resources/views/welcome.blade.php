...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/landpage/plugins/aos-animation/aos.css') }}">


    <link rel="stylesheet" href="{{ asset('assets/landpage/fonts/ep-icon-fonts/css/style.css')}}">

    <link rel="stylesheet" href="{{ asset('assets/landpage/fonts/fontawesome-5/css/all.min.css')}}">

    <link rel="stylesheet" href="{{ asset('assets/landpage/fonts/typography-font/typo-fonts.css')}}">
            ...
            <div class="row align-items-center">
                <div class="col-md-4 col-7">
                    <a href="index.html" class="site-brand">
                        <img src="{{ asset('assets/landpage/image/agille-Systems-logo.png')}}" alt="">
                    </a>
                </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12" id="dashboard">
                    <div class="dashboard-img" data-aos="fade-up" data-aos-duration='1500' data-aos-once="true">
                        <img src="{{asset('assets/landpage/image/dashboard-agille.png')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="content-img content-img-group-1">
                        <div class="image-1 d-none d-md-block " data-aos="fade-left" data-aos-duration='1500'
                             data-aos-once="true">
                            <img src="{{asset('assets/landpage/image/laptop-agillepng.png')}}" alt="">
                        </div>
                        <div class="image-2 image-overlay d-none d-md-block" data-aos="fade-right" data-aos-duration="1500" data-aos-once="true">
 ...
 env('APP_SUBDOMAIN') }}</span>
            ...
            <div class="card-group berlin-card-group">
                <div class="card testimonial-card-1">
                    ...
                    <div class="card-footer">
                        <div class="client-card">
                            <div class="image">
                                <img src="{{asset('assets/landpage/image/testimonial1.png')}}" alt="">
                            </div>
                            <div class="content">
                ...
                <div class="card testimonial-card-1">
                    ...
                    <div class="card-footer">
                        <div class="client-card">
                            <div class="image">
                                <img src="{{asset('assets/landpage/image/testimonial2.png')}}" alt="">
                            </div>
                            <div class="content">
                ...
                <div class="card testimonial-card-1">
                    ...
                    <div class="card-footer">
                        <div class="client-card">
                            <div class="image">
                                <img src="{{asset('assets/landpage/image/testimonial3.png')}}" alt="">
                            </div>
                            <div class="content">
    ...
    <footer class="section-padding-top footer-bg shape-holder" id="footer">
        ...
        <div class="footer-shapes">
            <div class="shape-1">
                <img src="{{asset('assets/landpage/image/footer-shape.svg')}}" alt="">
            </div>
            <div class="shape-2">
