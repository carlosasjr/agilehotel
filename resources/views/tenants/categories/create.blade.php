...
@section('title_postfix', ' - Cadastrar Nova Categoria')

@section('content_header')
    <div class="container-fluid">
        @include('tenants.includes.breadcrumbs',  ['title' => $title,
                               'breadcrumbs' => [
                               'Origens' => route('categories.index'),
...
@section('content')
    ...
    <div class="card card-outline card-info">
        ...
        <div class="card-body pad">
            @include('tenants.categories.partials.form')
        </div>
        <!-- /.card-body -->
    </div>
@stop
...
@section('js')
    ...
    <script type="text/javascript" src={{ asset('assets/js/categories/validation.js') }}></script>
@stop
