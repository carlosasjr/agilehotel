...
@section('title_postfix', ' - Cadastrar Novo Andar')

@section('content_header')
    <div class="container-fluid">
        @include('tenants.includes.breadcrumbs',  ['title' => $title,
                               'breadcrumbs' => [
                               'Origens' => route('floors.index'),
...
@section('content')
    ...
    <div class="card card-outline card-info">
        ...
        <div class="card-body pad">
            @include('tenants.floors.partials.form')
        </div>
        <!-- /.card-body -->
    </div>
@stop
...
@section('js')
    ...
    <script type="text/javascript" src={{ asset('assets/js/floors/validation.js') }}></script>
@stop
