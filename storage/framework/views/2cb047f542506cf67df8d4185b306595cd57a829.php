...
<?php $__env->startSection('title_postfix', ' - Origens'); ?>

<?php $__env->startSection('content_header'); ?>

    <?php echo $__env->make('tenants.includes.breadcrumbs',  ['title' => 'Gestão de Origens',
                                               'breadcrumbs' => [
                                               'Origens', ]
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create_origin')): ?>
            <p>
                <a href="<?php echo e(route('origins.create')); ?>" class="btn btn-primary">
    ...
    <!--TABELA -->
    <?php echo $__env->make('tenants.origins.partials.table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!--TABELA -->
    </div>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        var urlAjax = '<?php echo e(route('origins.index')); ?>';
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/agile/resources/views/tenants/origins/index.blade.php ENDPATH**/ ?>