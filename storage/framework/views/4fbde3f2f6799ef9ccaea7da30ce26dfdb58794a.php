...
<?php $__env->startSection('title_postfix', ' - Cadastrar País'); ?>
...
<?php $__env->startSection('content_header'); ?>
    <div class="container-fluid">
        <?php echo $__env->make('tenants.includes.breadcrumbs',  ['title' => 'Gestão de Pais',
                               'breadcrumbs' => [
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card card-outline card-info">
        ...
        <div class="card-body pad">
            <?php echo $__env->make('tenants.countries.partials.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <!-- /.card-body -->
    </div>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('js'); ?>
    ...
    <script type="text/javascript" src=<?php echo e(asset('assets/js/countries/validation.js')); ?>></script>
<?php $__env->stopSection(); ?>



<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/agile/resources/views/tenants/countries/create.blade.php ENDPATH**/ ?>