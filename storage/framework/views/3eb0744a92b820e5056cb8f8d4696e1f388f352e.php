<?php $__env->startSection('title_postfix', ' - Detalhes da Pessoa'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete_user')): ?>
        <?php echo Form::model($data, ['route' => ['people.destroy', $data->id], 'class' => 'form', 'method' => 'delete', 'id' => 'formDelete' ]); ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/agile/resources/views/tenants/people/show.blade.php ENDPATH**/ ?>