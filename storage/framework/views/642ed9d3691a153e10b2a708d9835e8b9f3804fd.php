...
<?php $__env->startSection('title_postfix', ' - Cadastrar Nova Pessoa'); ?>

<?php $__env->startSection('content_header'); ?>
    <div class="container-fluid">
        <?php echo $__env->make('tenants.includes.breadcrumbs',  ['title' => 'Gestão de Pessoas',
                               'breadcrumbs' => [
...
<?php $__env->startSection('content'); ?>
    ...
    <?php if( isset($data) ): ?>
        <?php echo Form::model($data, ['route' => ['people.update', $data->id], 'class' => 'form', 'method' => 'put', 'id' => 'formRegister', 'files' => true ]); ?>

    <?php else: ?>
        <?php echo Form::open(['route' => 'people.store', 'class' => 'form', 'id' => 'formRegister', 'files' => true]); ?>
    ...
    <div class="card card-outline card-info">
        ...
        <div class="card-body pad">
            <?php echo $__env->make('tenants.people.partials.identificacaoForm', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <!-- /.card-body -->
    </div>
    <!-- /.Identificação -->
    ...
    <div class="card card-outline card-gray">
        ...
        <!-- /.card-header -->
        <div class="card-body pad">
            <?php echo $__env->make('tenants.people.partials.outrosDadosForm', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <!-- /.card-body -->
    </div>
    <!-- /.Outros Dados -->
...
<?php $__env->startSection('js'); ?>
    <script>
        var submitAjaxPut = "<?php echo e(route('people.update', isset($data->id) ? $data->id : 0 )); ?>"
        var submitAjax = "<?php echo e(route('people.store')); ?>";
    ...
    <script src=<?php echo e(asset('assets/js/people/validation.js')); ?>></script>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/agile/resources/views/tenants/people/create.blade.php ENDPATH**/ ?>