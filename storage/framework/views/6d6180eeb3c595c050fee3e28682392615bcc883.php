...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card card-outline card-info">
        ...
        <div class="card-body pad">
            <?php echo $__env->make('tenants.profiles.partials.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <!-- /.card-body -->
    </div>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('js'); ?>
    ...
    <script type="text/javascript" src=<?php echo e(asset('assets/js/profiles/validation.js')); ?>></script>
<?php $__env->stopSection(); ?>



<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/agile/resources/views/tenants/profiles/create.blade.php ENDPATH**/ ?>