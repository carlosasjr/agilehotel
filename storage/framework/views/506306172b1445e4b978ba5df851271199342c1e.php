...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card card-outline card-info">
        ...
        <div class="card-body pad">
            <?php echo Form::open(['route' => ['profiles.users.add', $profile->id], 'class' => 'form form-search form-ds']); ?>


            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="form-group">
                    <label>
                        <?php echo Form::checkbox('users[]', $user->id); ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/agile/resources/views/tenants/profiles/users-add.blade.php ENDPATH**/ ?>