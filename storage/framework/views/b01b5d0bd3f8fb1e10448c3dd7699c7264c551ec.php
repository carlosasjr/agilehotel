...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content">
        <p>
            <a href="<?php echo e(route('permissions.profiles.list', $permission->id)); ?>" class="btn btn-primary">
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        var urlAjax = '<?php echo e(route('permissions.profiles', $permission->id)); ?>' ;
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/agile/resources/views/tenants/permissions/profiles.blade.php ENDPATH**/ ?>