...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card card-outline card-info">
        ...
        <div class="card-body pad">
            ...
            <p><strong>Pais: </strong><?php echo e($data->country->name); ?></p>
            <p><strong>Inicial: </strong><?php echo e($data->initials); ?></p>
    ...
    <?php echo Form::model($data, ['route' => ['states.destroy', $data->id], 'class' => 'form', 'method' => 'delete', 'id' => 'formDelete']); ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/agile/resources/views/tenants/states/show.blade.php ENDPATH**/ ?>