...
<?php $__env->startSection('body'); ?>
    <div class="lockscreen-wrapper">
        ...
        <div class="lockscreen-name"><?php echo e(isset(Auth::user()->name) ? Auth::user()->name : Auth::user()->email); ?></div>
        ...
        <div class="lockscreen-item">
            ...
            <form method="POST" action="<?php echo e(route('password.confirm')); ?>" class="lockscreen-credentials <?php if(!config('adminlte.usermenu_image')): ?>ml-0 <?php endif; ?>">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="password" required autocomplete="current-password" placeholder="<?php echo e(__('adminlte::adminlte.password')); ?>" autofocus>
...
<?php echo $__env->make('adminlte::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/agile/vendor/jeroennoten/laravel-adminlte/resources/views/passwords/confirm.blade.php ENDPATH**/ ?>