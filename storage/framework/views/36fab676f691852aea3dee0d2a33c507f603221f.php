...
<?php $__env->startSection('body'); ?>
    <div class="wrapper">
        <?php if(config('adminlte.layout_topnav') || View::getSection('layout_topnav')): ?>
            <nav
                class="main-header navbar <?php echo e(config('adminlte.classes_topnav_nav', 'navbar-expand-md')); ?> <?php echo e(config('adminlte.topnav_color', 'navbar-white navbar-light')); ?>">
                <div class="<?php echo e(config('adminlte.classes_topnav_container', 'container')); ?>">
                    <?php if(config('adminlte.logo_img_xl')): ?>
                        <a href="<?php echo e($dashboard_url); ?>" class="navbar-brand logo-switch">
                            <img
                                src="<?php echo e(asset(config('adminlte.logo_img', 'vendor/adminlte/dist/img/AdminLTELogo.png'))); ?>"
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#">
                                        <?php echo e(session('company')['name'] ?? ''); ?>
                                ...
                                <?php if(config('adminlte.right_sidebar')): ?>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#" data-widget="control-sidebar"
                                           <?php if(!config('adminlte.right_sidebar_slide')): ?> data-controlsidebar-slide="false"
                                           <?php endif; ?> <?php if(config('adminlte.right_sidebar_scrollbar_theme', 'os-theme-light') != 'os-theme-light'): ?> data-scrollbar-theme="<?php echo e(config('adminlte.right_sidebar_scrollbar_theme')); ?>"
                                           <?php endif; ?> <?php if(config('adminlte.right_sidebar_scrollbar_auto_hide', 'l') != 'l'): ?> data-scrollbar-auto-hide="<?php echo e(config('adminlte.right_sidebar_scrollbar_auto_hide')); ?>" <?php endif; ?>>
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        <div class="image">
                            <?php if( !empty(auth()->user()->image) ): ?>
                                <img src="<?php echo e(asset('storage/tenants/users/' . auth()->user()->image)); ?>" alt="<?php echo e(auth()->user()->name); ?>" class="user-dashboard img-circle">
                            <?php else: ?>
                                <img src="<?php echo e(url('assets/images/no-image.png')); ?>" alt="SoftPro" class="user-dashboard img-circle">
                            <?php endif; ?>
                        </div>
                        <div class="info">
                    ...
                    <div class="sidebar">
                        <nav class="mt-2">
                            <ul class="nav nav-pills nav-sidebar flex-column <?php echo e(config('adminlte.classes_sidebar_nav', '')); ?>"
                                ...
                                <?php if(config('adminlte.sidebar_nav_animation_speed') != 300): ?> data-animation-speed="<?php echo e(config('adminlte.sidebar_nav_animation_speed')); ?>"
                                <?php endif; ?> <?php if(!config('adminlte.sidebar_nav_accordion')): ?> data-accordion="false" <?php endif; ?>>
...
<?php echo $__env->make('adminlte::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Projects/Agile/resources/views/vendor/adminlte/page.blade.php ENDPATH**/ ?>